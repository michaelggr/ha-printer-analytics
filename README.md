...
<p align="center">
  <img src="https://raw.githubusercontent.com/michaelggr/ha-printer-analytics/main/screenshots/realtime-monitor.jpg" width="220" alt="Realtime Monitor">
  <img src="https://raw.githubusercontent.com/michaelggr/ha-printer-analytics/main/screenshots/statistics.jpg" width="220" alt="Statistics">
  <img src="https://raw.githubusercontent.com/michaelggr/ha-printer-analytics/main/screenshots/history-list.jpg" width="220" alt="History List">
</p>
<p align="center">
  <img src="https://raw.githubusercontent.com/michaelggr/ha-printer-analytics/main/screenshots/full-page.jpg" width="460" alt="Full Page">
</p>
...
├── www/
│   └── pa-v5.11.js       # Lovelace custom card
└── tests/                # Test suite
```
...
### v5.11.0 (2026-05-21) — Server-Side Pagination & Rich Analytics

**Python Backend:**
- WebSocket server-side pagination — supports 5,000+ history records
- Server-side filtering (status / color / date / keyword / combined filters)
- Multi-printer data merging via WebSocket
- CSV export with filtered data

**Frontend JS (v5.11):**
- Loading animation optimization
- Color usage comparison chart
- Filament type usage comparison chart
...
#### v5.11.0 (2026-05-21) — 服务端分页与丰富分析

**Python 后端：**
- WebSocket 服务端分页，支持 5000+ 条历史记录
- 服务端筛选（状态/颜色/日期/搜索/组合筛选）
- 多打印机数据合并
- CSV 导出功能
